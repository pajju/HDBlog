...
class Duyurular(models.Model):
   ...
   baslik    	    = models.CharField(max_length=255, verbose_name="Baslik", help_text = "Duyuru Basligi")
   sef_baslik	    = models.CharField(max_length=255, verbose_name="Baslik Sef", help_text = "Baslik Sef", blank=True) 
   slug      	    = models.SlugField(max_length=255, verbose_name="Slug")
   
   aciklama    	    = models.CharField(max_length=500, verbose_name="Aciklama", help_text = "Duyuru Aciklamasi")
   ...
   resim  		    = models.CharField(max_length=255, verbose_name="Resim", help_text = "Resim", choices=RESIMLER) 
   ...
   def save(self, *args, **kwargs):
       ...
       super(Duyurular, self).save(*args, **kwargs)
