...
class Banner(models.Model):
   baslik    	    = models.CharField(max_length=255, verbose_name="Baslik", help_text = "Reklam Basligi")
   sef_baslik	    = models.CharField(max_length=255, verbose_name="Baslik Sef", help_text = "Baslik Sef", blank=True) 
   
   aciklama    	    = models.CharField(max_length=500, verbose_name="Aciklama", help_text = "Reklam Aciklamasi")
...
class TextLink(models.Model):
   ...
   class Meta:
	   verbose_name_plural = "Text Linkler"
	   
class TanitimYazisi(models.Model):
   RESIM = (
   ...
   resim			= models.CharField(max_length=50, verbose_name="Reklam Resmi", help_text = "Reklam Resmi", choices=RESIM)
  
   icerik       	= models.TextField(verbose_name="Tum Icerik", help_text = "Tum Icerik", blank=True)
   ...
   def save(self, *args, **kwargs):
       self.sef_baslik = unidecode(self.baslik)
       super(TanitimYazisi, self).save(*args, **kwargs)
	  
       self.aciklama_sef = unidecode(self.aciklama)
       super(TanitimYazisi, self).save(*args, **kwargs)
	   
   class Meta:
	   verbose_name_plural = "Tanitim Yazilari"
